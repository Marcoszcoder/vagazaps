  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-100 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/" className="text-xl font-bold text-[#16a34a]">
          VagaZaps
        </Link>

        <div className="hidden items-center gap-8 md:flex">
          <a href="#" className="text-sm font-medium text-slate-700 transition-colors hover:text-[#16a34a]">
            Início
          </a>
      ...
      {menuOpen && (
        <div className="border-t border-slate-100 bg-white px-4 pb-4 pt-2 md:hidden">
          <div className="flex flex-col gap-3">
            <a href="#" className="rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Início
            </a>
            <a href="#como-funciona" onClick={() => setMenuOpen(false)} className="rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Como funciona
            </a>
            <a href="#planos" onClick={() => setMenuOpen(false)} className="rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Planos
            </a>
            ...
            <Link href="/cadastro" className="rounded-lg bg-[#16a34a] px-3 py-2 text-center text-sm font-semibold text-white hover:bg-[#15803d]">
              Criar conta
            </Link>
          </div>
        </div>
