        ...
        <div className="text-center">
          ...
          <div className="mt-8 flex flex-row items-center justify-center gap-1">
            ...
            >
              ...
              <span className="pointer-events-none absolute inset-0 -translate-x-full animate-[shine_3s_ease-in-out_infinite] bg-gradient-to-r from-transparent via-white/30 to-transparent" />
            </Link>
            <a
              href="#como-funciona"
              ...
              <div className="rounded-[1.3rem] bg-slate-800 p-[2px]">
                <div className="relative rounded-[1.1rem] overflow-hidden bg-[#111b21]">
                  ...
                  <div className="flex items-center justify-between px-4 pt-3 pb-1">
                    <span className="text-[6px] font-semibold text-white">9:41</span>
                  ...
                  <div className="bg-[#1f2c34] px-3 py-2">
                    <span className="text-[8px] font-semibold text-white">Minhas Vagas</span>
                  </div>
                  <div className="bg-[#0b141a] p-2 space-y-1.5 min-h-[200px]">
                    <div className="rounded-md bg-[#1d2e35] p-2">
                      <p className="text-[7px] font-bold text-white">Dev Full Stack</p>
                      <p className="text-[6px] text-slate-400">Curitiba • R$ 6.500</p>
                      <div className="mt-1 h-1 rounded-full bg-[#22c55e]" style={{ width: '92%' }} />
                    </div>
                    <div className="rounded-md bg-[#1d2e35] p-2">
                      <p className="text-[7px] font-bold text-white">Analista Marketing</p>
              ...
              <div className="rounded-[2.3rem] bg-slate-900 p-[2px]">
                <div className="relative rounded-[2.1rem] overflow-hidden bg-[#111b21]">
                  ...
                  <div className="space-y-2 bg-[#0b141a] p-3 min-h-[220px]">
                    ...
                    <div className="max-w-[92%] rounded-lg rounded-tl-none bg-[#1d2e35] p-2">
                      <div className="flex items-center gap-1 mb-1">
